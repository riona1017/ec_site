...
class ItemController extends Controller
{
    ...
    public function index()
    {
        ...
        ->join('images as image2', 'products.image2', '=', 'image2.id') //image4まで消去しても問題なし
        ->join('images as image3', 'products.image3', '=', 'image3.id')
        ->join('images as image4', 'products.image4', '=', 'image4.id')
        ->where('shops.is_selling', true)
        ->where('products.is_selling', true)
        ->select('products.id', 'products.name as name', 'products.price', 'products.sort_order as sort_order',
